...
// Inclusione Stili e Script personalizzati
...
{
    // Definizione ed inclusione del dominio di lingua e del supporto alle traduzioni
    ...
    // Registrazione Post Type personalizzato
    register_post_type(
        'project',
        array(
...
// Inclusione Shortcodes
include_once("shortcodes/shortcode.php");
include_once("shortcodes/paragrafo.php");
...
//add_action('init', 'imm_widgets_init');	// Decommenta per attivare la registrazione del widget

// Inclusione Blocchi personalizzati
